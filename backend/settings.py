...
SECRET_KEY = 'django-insecure-^x)-l%#+4oo)_2h1xf2yzsj$yijlh00-4ans!^0-f5^xw$5y3d'
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        'api.authorization.CookieJWTAuthentication',
...
SIMPLE_JWT = {
    ...
    "AUTH_COOKIE_SAMESITE": "Lax",  # O "Strict" si no usas subdominios
}
